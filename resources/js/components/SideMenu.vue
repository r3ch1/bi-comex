  ...
  <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'" class="sidebar fixed top-0 left-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-auto border-r border-gray-200 bg-white px-5 transition-all duration-300 lg:static lg:translate-x-0 dark:border-gray-800 dark:bg-black -translate-x-full" @click.outside="sidebarToggle = false">
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <div>
            ...
            <!-- Menu Item Dashboard -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')" class="menu-item group menu-item-active" :class=" (selected === 'Dashboard') || (page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks' || page === 'saas') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="index.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'ecommerce' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        eCommerce
                    </a>
                    </li>
                    <li>
                    <a href="analytics.html" class="menu-dropdown-item group menu-dropdown-item-active" :class="page === 'analytics' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Analytics
                        <span class="absolute right-3 flex items-center gap-1">
                        <span class="menu-dropdown-badge menu-dropdown-badge-active" :class="page === 'analytics' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'">
                            Pro
                        </span>
                        </span>
                    </a>
                    ...
                    <li>
                    <a class="menu-dropdown-item group menu-dropdown-item-inactive" href="marketing.html" :class="page === 'marketing' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Marketing
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="crm.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'crm' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        CRM
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="stocks.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'stocks' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Stocks
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="saas.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'saas' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        SaaS
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <!-- Menu Item Calendar -->
            <li>
                <a href="calendar.html" @click="selected = (selected === 'Calendar' ? '':'Calendar')" class="menu-item group menu-item-inactive" :class=" (selected === 'Calendar') &amp;&amp; (page === 'calendar') ? 'menu-item-active' : 'menu-item-inactive'">
            ...
            <!-- Menu Item Profile -->
            <li>
                <a href="profile.html" @click="selected = (selected === 'Profile' ? '':'Profile')" class="menu-item group menu-item-inactive" :class=" (selected === 'Profile') &amp;&amp; (page === 'profile') ? 'menu-item-active' : 'menu-item-inactive'">
            ...
            <!-- Menu Item Task -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Task' ? '':'Task')" class="menu-item group menu-item-inactive" :class=" (selected === 'Task') || (page === 'taskList' || page === 'taskKanban') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="task-list.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'taskList' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        List
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="task-kanban.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'taskKanban' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Kanban
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <!-- Menu Item Forms -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Forms' ? '':'Forms')" class="menu-item group menu-item-inactive" :class=" (selected === 'Forms') || (page === 'formElements' || page === 'formLayout' || page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="form-elements.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'formElements' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Form Elements
                    </a>
                    </li>
                    <li>
                    <a href="form-layout.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'formLayout' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Form Layout
                    </a>
                    </li>
                </ul>
            ...
            <!-- Menu Item Tables -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Tables' ? '':'Tables')" class="menu-item group menu-item-inactive" :class="(selected === 'Tables') || (page === 'basicTables' || page === 'dataTables') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="basic-tables.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'basicTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Basic Tables
                    </a>
                    </li>
                    <li>
                    <a href="data-tables.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'dataTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Data Tables
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <!-- Menu Item Pages -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Pages' ? '':'Pages')" class="menu-item group menu-item-inactive" :class="(selected === 'Pages') || (page === 'fileManager' || page === 'pricingTables' || page === 'blank' || page === 'page404' || page === 'page500' || page === 'page503' || page === 'success' || page === 'faq' || page === 'comingSoon' || page === 'maintenance') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="file-manager.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'fileManager' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        File Manager
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="pricing-tables.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'pricingTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Pricing Tables
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="faq.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'faq' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Faq
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="blank.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'blank' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Blank Page
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="404.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'page404' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        404 Error
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="500.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'page500' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        500 Error
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="503.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'page503' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        503 Error
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="coming-soon.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'comingSoon' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Coming Soon
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="maintenance.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'termsCondition' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Maintenance
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="success.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'success' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Success
                        <span class="absolute right-3 flex items-center gap-1">
        ...
        <div>
            ...
            <!-- Menu Item Chat -->
            <li>
                <a href="chat.html" @click="selected = (selected === 'Chat' ? '':'Chat')" class="menu-item group menu-item-inactive" :class=" (selected === 'Chat') &amp;&amp; (page === 'chat') ? 'menu-item-active' : 'menu-item-inactive'">
            ...
            <!-- Menu Item Inbox -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Email' ? '':'Email')" class="menu-item group menu-item-inactive" :class="(selected === 'Email') || (page === 'inbox' || page === 'inboxDetails') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="inbox.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'inbox' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Inbox
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="inbox-details.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'inboxDetails' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Details
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <!-- Menu Item Invoice -->
            <li>
                <a href="invoice.html" @click="selected = (selected === 'Invoice' ? '':'Invoice')" class="menu-item group menu-item-inactive" :class=" (selected === 'Invoice') &amp;&amp; (page === 'invoice') ? 'menu-item-active' : 'menu-item-inactive'">
        ...
        <div>
            ...
            <!-- Menu Item Charts -->
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Charts' ? '':'Charts')" class="menu-item group menu-item-inactive" :class="(selected === 'Charts') || (page === 'lineChart' || page === 'barChart' || page === 'pieChart') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="line-chart.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'lineChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Line Chart
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="bar-chart.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'barChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Bar Chart
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="pie-chart.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'pieChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Pie Chart
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <li>
                <a href="#" @click.prevent="selected = (selected === 'UiElements' ? '':'UiElements')" class="menu-item group menu-item-inactive" :class="(selected === 'UiElements') || (page === 'alerts' || page === 'avatars' || page === 'badge' || page === 'breadcrumb' || page === 'buttons' || page === 'buttonsGroup' || page === 'cards'|| page === 'carousel' || page === 'dropdowns' || page === 'images' || page === 'list' || page === 'modals' || page === 'notifications' || page === 'pagination' || page === 'popovers' || page === 'progress' || page === 'spinners' || page === 'tooltips' || page === 'videos') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="alerts.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'alerts' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Alerts
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="avatars.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'avatars' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Avatars
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="badge.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'badge' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Badge
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="breadcrumb.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'breadcrumb' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Breadcrumb
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="buttons.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'buttons' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Buttons
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="buttons-group.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'buttonsGroup' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Buttons Group
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="cards.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'cards' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Cards
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="carousel.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'carousel' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Carousel
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="dropdowns.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'dropdowns' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Dropdowns
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="images.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'images' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Images
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="links.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'links' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Links
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="list.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'list' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        List
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="modals.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'modals' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Modals
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="notifications.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'notifications' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Notifications
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="pagination.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'pagination' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Pagination
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="popovers.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'popovers' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Popovers
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="progress-bar.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'progress' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Progress Bars
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="ribbons.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'ribbons' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Ribbons
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="spinners.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'spinners' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Spinners
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="tabs.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'tabs' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Tabs
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="tooltips.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'tooltips' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Tooltips
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="videos.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'videos' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Videos
                        <span class="absolute right-3 flex items-center gap-1">
            ...
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Authentication' ? '':'Authentication')" class="menu-item group menu-item-inactive" :class="(selected === 'Authentication') || (page === 'basicChart' || page === 'advancedChart') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                    <li>
                    <a href="signin.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'signin' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Sign In
                    </a>
                    </li>
                    <li>
                    <a href="signup.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'signup' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Sign Up
                    </a>
                    </li>
                    <li>
                    <a href="reset-password.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'resetPassword' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                        Reset Password
                        <span class="absolute right-3 flex items-center gap-1">
                    ...
                    <li>
                    <a href="two-step-verification.html" class="menu-dropdown-item group menu-dropdown-item-inactive" :class="page === 'twoStepVerification' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
