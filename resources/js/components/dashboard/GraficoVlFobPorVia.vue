...
export default {
    ...
    setup(props) {
        ...
        const load = async () => {
            ...
            axios
                .get(
                    `api/exportacoes/${props.uf}/get-totais-por-campo/vl_fob/via_id`,
                    {
                ...
                .then((res) => {
                    data.value = {
                        ...
                        options: {
                            ...
                            labels: res.data.data.map((d) => d.via.nome),
                            responsive: [
                                {
                                    breakpoint: 480,
                                    options: {
...
<template>
    ...
    <div class="custom-scrollbar max-w-full overflow-x-auto" v-if="!loading">
        <apexchart type="donut" :options="data.options" :series="data.series" />
    </div>
</template>
